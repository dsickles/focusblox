  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Focus Blox — A calm daily planning workspace" },
      {
        ...
        content:
          "A calm daily planning workspace. Define what matters, then reserve time for it.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Focus Blox — A calm daily planning workspace" },
      { name: "description", content: "Focus Blox is a calm daily planner for intentional focus, not productivity optimization." },
      { property: "og:description", content: "Focus Blox is a calm daily planner for intentional focus, not productivity optimization." },
      { name: "twitter:description", content: "Focus Blox is a calm daily planner for intentional focus, not productivity optimization." },
    ...
    htmlAttrs: { lang: "en", class: "dark", style: "color-scheme: dark" },
  }),
